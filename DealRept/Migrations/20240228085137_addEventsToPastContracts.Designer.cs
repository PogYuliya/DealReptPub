...
namespace DealRept.Migrations
{
    ...
    [Migration("20240228085137_addEventsToPastContracts")]
    partial class addEventsToPastContracts
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DealRept.Models.Event", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DealRept.Models.Event", b =>
                {
                    b.HasOne("DealRept.Models.CurrentContract", "Contract")
                        .WithMany("Events")
                        .HasForeignKey("ContractID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DealRept.Models.PastContract", null)
                        .WithMany("Events")
